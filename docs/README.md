...
| **实战产品蓝图** | BootMall（云市商城）：分主题维护的业务映射、领域模型、里程碑与实践队列——边学习边在 boot-server 落地 | [蓝图总览](10-实战产品蓝图/README.md) |
| 配套学习资源清单 | 各阶段推荐书籍 / 官方文档汇总 | [配套学习资源清单.md](配套学习资源清单.md) |

## 文档与工程落点

`boot-server/` 不是要等全部课程学完才打开的独立项目，而是伴随主线逐步生长的练习载体。每次只实现当前阶段能解释清楚的部分，具体领域范围与里程碑见 [实战产品蓝图](10-实战产品蓝图/README.md)。

| 学习节点 | 在 boot-server 中做什么 | 验收结果 |
|-|-|-|
